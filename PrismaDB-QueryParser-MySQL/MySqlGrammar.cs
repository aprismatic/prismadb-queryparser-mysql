...
namespace PrismaDB.QueryParser.MySQL
{
    ...
    public class MySqlGrammar : Grammar
    {
        public MySqlGrammar() : base(false)
        {
            ...
            var describeStmt = new NonTerminal("describeStmt");
            ...
            var tableItemList = new NonTerminal("tableItemList");
            var tableItem = new NonTerminal("tableItem");
            ...
            var et_ADDITION = ToTerm("ADDITION");
            var et_MULTIPLICATION = ToTerm("MULTIPLICATION");
            var et_SEARCH = ToTerm("SEARCH");
            var et_RANGE = ToTerm("RANGE");
            var et_WILDCARD = ToTerm("WILDCARD");
            ...
            encryptType.Rule = et_STORE | et_ADDITION | et_MULTIPLICATION | et_SEARCH | et_RANGE | et_WILDCARD;
            ...
            showStmt.Rule = "SHOW" + "TABLES";
            describeStmt.Rule = "DESCRIBE" + Id;
            ...
            fromClauseOpt.Rule = Empty | FROM + tableItemList + joinClauseListOpt;
            tableItemList.Rule = MakePlusRule(tableItemList, comma, tableItem);
            tableItem.Rule = Id + aliasOpt;
            joinClauseListOpt.Rule = Empty | joinClauseList;
            joinClauseList.Rule = MakePlusRule(joinClauseList, joinClause);
            joinClause.Rule = joinKindOpt + JOIN + tableItem + joinOnOpt;
